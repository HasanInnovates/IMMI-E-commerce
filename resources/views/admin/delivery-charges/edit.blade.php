...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0">Edit Delivery Area</h4>
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        <form method="POST" action="{{ route('admin.delivery-charges.update', $charge) }}">
            @csrf @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="text" id="area_name" name="area_name"
                       ...
                       value="{{ old('area_name', $charge->area_name) }}" required>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="number" step="0.01" min="0" id="charge" name="charge"
                           ...
                           value="{{ old('charge', $charge->charge) }}" required>
